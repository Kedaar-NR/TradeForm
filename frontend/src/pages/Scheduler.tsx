...
const Scheduler: React.FC = () => {
  ...
  const handleFile = async (file: File) => {
    try {
      ...
      console.error("Failed to parse BOM:", err);
      setError("Could not read that file. Try another .xlsx or .csv.");
    }
  };
      ...
      <div className="card p-6 border-dashed border-2 border-gray-200 bg-gradient-to-br from-white to-gray-50">
        ...
        {fileName && (
          <div className="mt-3 flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-700 font-medium">Loaded: {fileName}</span>
          </div>
        )}
        {error && (
