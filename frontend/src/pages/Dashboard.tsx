...
const Dashboard: React.FC = () => {
    ...
    useEffect(() => {
        const handleScroll = () => {
            if (!projectsSectionRef.current || !studiesSectionRef.current)
                return;

            const projectsTop =
                projectsSectionRef.current.getBoundingClientRect().top;
            const studiesTop =
                studiesSectionRef.current.getBoundingClientRect().top;
        ...
        try {
            ...
            const newGroup: ProjectGroup = {
                ...
                updatedAt:
                    ...
                    new Date().toISOString(),
                createdBy: (response.data as { created_by?: string })
                    .created_by,
            };
        ...
        <div className="space-y-8 animate-fade-in pb-16">
            ...
            <div>
                ...
                <p className="text-gray-600">
                    Automate your engineering component evaluations with
                    AI-powered analysis
                </p>
            </div>
